...
prompt = PromptTemplate(
    template="""
    You are an expert email assistant. Your job is to generate a {email_type}, clear, and context-aware email **reply** based on the user's current query , prior email conversation and retrieved context data from documents.
    ...
    **Retrieved Coontext:**
    ...
    """,
    input_variables=["previous_response","email_input","query","context","email_type"]
)
